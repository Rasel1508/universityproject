...
<body>
  <section class="image">
    <form class="reg-box border-warning" action="adminfile.php" method="post">
      <h3 class="text-capitalize text-center text-white p-lg-4">Register as a Admin</h3>
  ...
  <div class="form-group ">
    <input type="text" class="form-control" name="code" placeholder="Admin Code">
  </div>
  <div class="form-group">
...
<div>
   <input type="submit" name="submit" class="btn btn-success" href="adminlogin.php" value="Create My Account">
</div>
<p class="text-warning pt-4">
      Already a member: <a class="text-white" href="adminLogin.php">SIGN IN</a>
    </p>
</form>
</div>
</form>
